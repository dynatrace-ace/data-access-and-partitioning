...
8. Validate that the command worked after a few minutes and make sure the enrichment is there under the labels section of the Notebook (if it's not, please run the command above again).
